...
#define SOF_BT_OFFLOAD_PRESENT		BIT(17)
							  ...
							  int hdmi_num)
{
	...
	/* bt-offload */
	if (sof_rt5682_quirk & SOF_BT_OFFLOAD_PRESENT) {
		/* enabled on ssp2 by default */
		links[id].id = id;
		links[id].cpus = &cpus[id];
		links[id].cpus->dai_name = "SSP2 Pin";
		links[id].name = "SSP2-Codec";
